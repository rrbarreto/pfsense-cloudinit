...
class FreeBSDUtils(base.BaseOSUtils):
    ...
    def set_host_name(self, new_host_name):
        ...
        #cmd = "(echo \"print_r(\$config['system']['user']);\" ; echo \"exec;\" ; echo exit ) | pfSsh.php"
        cmd = "(echo \"\$config['system']['hostname'] = '" + new_host_name + "';\" ; echo \"write_config();\" ; echo \"exec;\" ; echo exit) | pfSsh.php"
        subprocess.check_call(cmd, stderr=subprocess.STDOUT, shell=True)

    def set_ssh_public_keys(self, public_key):
        #cmd = "(echo \"print_r(\$config['system']['user']);\" ; echo \"exec;\" ; echo exit ) | pfSsh.php"
        public_key_encoded = base64.b64encode(public_key)
        cmd = "(echo \"\$config['system']['user'][0]['authorizedkeys'] = '" + public_key_encoded + "';\" ; echo \"write_config();\" ; echo \"exec;\" ; echo exit ) | pfSsh.php"
        subprocess.check_call(cmd, stderr=subprocess.STDOUT, shell=True)
    ...
    def set_user_password(self, username, password):
        ...
        pw_cmd = "( echo " + username + "; echo " + password + "; echo " + password + "; echo exit ) | pfSsh.php playback changepassword"
        subprocess.check_call(pw_cmd, shell=True)
